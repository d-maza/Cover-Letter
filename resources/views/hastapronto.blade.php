...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400;600&family=Rubik+Dirt&family=Special+Elite&display=swap"
        rel="stylesheet">
    ...
    * {
    ...
    body {
        ...
        background-image: url('https://github.com/d-maza/Cover-Letter/blob/main/public/img/fondobn.png?raw=true');
    ...
    .message {
        ...
        -webkit-animation: message-frames 6s ease 3s forwards;
        animation: message-frames 6s ease 3s forwards;
        opacity: 0;
        height: 68vh;
        width: 138%;
        display: flex;
...
<body>
    <main>
        ...
        <h2 class="message p-4"> “Yo puedo hacer cosas que tú no puedes,</h2>
        <br>

        <br>
        <h2 class="message mt-5"> tú puedes hacer cosas que yo no puedo; </h2>
        <br>

        <br>
        <h2 class="message mt-5"> juntos
            podemos hacer grandes cosas.” </h2>
        <br>
        <br>
        <br>
        <br>
        <br>
        <h2 class="message mt-5">- Mª Teresa de Calcuta -</h2>
