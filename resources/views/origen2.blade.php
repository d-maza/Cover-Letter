        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            <img src="https://sdk.bitmoji.com/render/panel/20043862-99096523782_8-s5-v1.png?transparent=1&palette=1&scale=2"
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-lg font-semibold">
                                <p>Y así fue como empecé a formarme dentro del buceo. Con los años fui sacando más
                                    y más
                                    titulaciones para ir avanzando en mi carrera profesional. 🚀🚀.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        <a href="/origen" class="ml-1 underline">
                ...
                <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                    <div class="flex items-center">
                        <a href="/origen3" class="ml-1 underline mr-2">
